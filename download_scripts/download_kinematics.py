...
Command Line Inputs:
Starting row value in millions (5,10,... etc) corresponding to for example "start offset at 5 million". We use a row limit of 9 million here

Outputs:
Writes the desired data for input patch to data_dir according to ADQL_base_script (defined below)
